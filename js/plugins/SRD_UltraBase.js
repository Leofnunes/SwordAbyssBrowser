...
Imported.SRD_UltraBase = 0x010200;
...
Bitmap.prototype.fillRectOutline = function(x, y, width, height, size, color) {
	...
	context.fillRect(x, y, width, size);
	context.fillRect(x, y + height - size, width, size);
	context.fillRect(x, y + size, size, height - (size * 2));
	context.fillRect(x + width - size, y + size, size, height - (size * 2));
	context.restore();
